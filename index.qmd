...
## Answer: Below are 100 simulations of the original game over 30 years (age 25 to 55) with a Matplotlib histogram showing the distribution of final balances. The results show extreme variability - while some paths end very high, many end very low due to the multiplicative nature of the game.
...
# OO Matplotlib histogram
fig, ax = plt.subplots(figsize=(10, 6))
ax.hist(final_balances, bins=20, color='plum', alpha=0.8, edgecolor='black', linewidth=0.8)
